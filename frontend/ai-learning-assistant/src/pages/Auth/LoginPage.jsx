        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 placeholder-slate-400 text-sm font-medium transition-all focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus-shadow-emerald-500/10  duration-200"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50  text-slate-900 placeholder-slate-400 text-sm font-medium focus:outline-none focus:border-emerald-500 focus:bg-white 
            ...
            <button
              ...
              active:scale-[0.98] text-white text-sm
