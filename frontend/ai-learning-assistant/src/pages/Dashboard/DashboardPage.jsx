          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className={`w-11 h-11 rounded-xl bg-linear-to-br ${stat.gradient} shadow-lg flex items-center justify-center`}>
              ...
              {[
                ...
                .map((activity, index) => (
                  <div
                    ...
                    className="group flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border hover:border-slate-300/60
                    hover:bg-white border-slate-200/60 hover:shadow-md transition-all duration-200"
                  >
