...
const QuizResultPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Score Card */}
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-lg shadow-slate-200/50 p-8 mb-8">
...
<div className="mt-8 flex justify-center">
  <Link to={`/documents/${quiz.document._id}`}>
    <button className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white rounded-xl font-semibold shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden hover:shadow-emerald-500/40 transition-all duration-200">
